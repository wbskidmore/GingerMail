export function summarizeThreadPrompt() {
    return [
...
export function draftReplyPrompt(tone, intent) {
...
export function extractActionItemsPrompt() {
    return [
...
export function classifySendersForUnsubscribePrompt() {
    return [
...
export function prioritizeInboxPrompt() {
    return [
