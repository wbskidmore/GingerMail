 ...
 */
export const gingermailTheme = createTheme({
    primaryColor: 'ginger',
    ...
    defaultRadius: 'md',
    cursorType: 'pointer',
    fontFamily: '-apple-system, BlinkMacSystemFont, "Segoe UI", "SF Pro Text", system-ui, Helvetica, Arial, sans-serif',
    fontFamilyMonospace: 'ui-monospace, SFMono-Regular, "SF Mono", Menlo, Consolas, "Liberation Mono", monospace',
    headings: {
        fontFamily: '-apple-system, BlinkMacSystemFont, "Segoe UI", "SF Pro Display", system-ui, Helvetica, Arial, sans-serif',
        sizes: {
