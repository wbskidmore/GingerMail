...
export type FolderRole = 'inbox' | 'sent' | 'drafts' | 'trash' | 'spam' | 'archive' | 'all' | 'custom';
...
export type ScheduledJobKind = 'event-reminder' | 'task-due' | 'snooze-wake' | 'ai-digest' | 'focus-break';
 ...
 */
export type MailActionId = 'reply' | 'replyAll' | 'forward' | 'archive' | 'trash' | 'move' | 'markUnread' | 'flag' | 'snooze' | 'spam' | 'print' | 'aiSummarise';
/**
...
export declare const DEFAULT_MAIL_TOOLBAR: MailToolbarSettings;
 ...
 */
export declare const AI_VENDOR_HOSTS: Record<'openai' | 'anthropic' | 'google', string[]>;
