...
export function wrapLoggerWithScrub<T extends MinimalLogger>(logger: T): T {
  const wrap = (method: keyof MinimalLogger) => {
...
export function installConsoleScrubbing(): void {
